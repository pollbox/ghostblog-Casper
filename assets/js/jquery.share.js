...
;(function($){
    ...
    $.fn.share = function ($options) {
        ...
        var $defaults = {
            url: $head.find('[property="og:url"]').attr('content') || '',
            site_url: location.origin,
            source: $head.find('[property="og:site_name"]').attr('content') || document.title,
            title: $head.find('[property="og:title"]').attr('content') || document.title,
            description: $head.find('[property="og:description"]').attr('content') || '',
            image: $head.find('[property="og:image"]').attr('content') || '',
            ...
            disabled: ['tencent','linkedin','diandian','facebook','twitter','google'],
            initialized: false
        };
